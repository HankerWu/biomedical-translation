...
class MTDataset(Dataset):
    def __init__(self, data_path):
        self.out_en_sent, self.out_cn_sent = self.get_dataset(data_path,
                                                              sort=True)
    ...
    def get_dataset(self, data_path, sort=False):
        ...
        with open(data_path + '.en', 'r') as en:
            out_en_sent.append(en.readline())
        
        with open(data_path + '.zh', 'r') as zh:
            out_cn_sent.append(zh.readline())
