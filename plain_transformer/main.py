...
def get_std_opt(model):
    ...
    return NoamOpt(
        model.src_embed[0].d_model, 1, 10000,
...
def translate_example():
    """单句翻译示例"""
    sent = r"Early interactions with signiﬁcant individuals affect social experience throughout the course of a lifetime, as a repeated and prolonged perception of different levels of care, independence or control inﬂuences the modulation of emotional regulatory processes."
