...
def run():
    # en_input = './data/train.en'
    # en_vocab_size = 32000
    # en_model_name = 'eng'
    # en_model_type = 'bpe'
    # en_character_coverage = 1
    # train(en_input, en_vocab_size, en_model_name, en_model_type,
    #       en_character_coverage)

    ch_input = './data/train.zh'
    ch_vocab_size = 32000
    ch_model_name = 'chn'
    ch_model_type = 'bpe'
    ch_character_coverage = 0.9995
    train(ch_input, ch_vocab_size, ch_model_name, ch_model_type,
          ch_character_coverage)
